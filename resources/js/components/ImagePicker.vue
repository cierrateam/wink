        ...
        methods: {
            ...
            closeUnplashModalAndInsertImage() {
                this.$emit('changed', {
                    ...
                    caption: 'Foto von <a href="' + this.selectedUnsplashImage.user.links.html + '">' + this.selectedUnsplashImage.user.name + '</a> von <a href="https://unsplash.com">Unsplash</a>',
                });
...
<template>
  <div>
    ...
    <div class="mb-0">
      Please
      <label :for="'imageUpload'+_uid" class="cursor-pointer underline">upload</label> an image
        ...
        <div class="container py-20">
          <div class="flex items-center">
            ...
            <button
              ...
              @click="closeUnplashModalAndInsertImage"
            >Choose Selected Image</button>
          ...
          <div v-if="!searchingUnsplash && unsplashImages.length" class="flex flex-wrap mt-5">
            <div
              class="w-1/4 p-1 cursor-pointer"
              v-for="image in unsplashImages"
              @click="selectedUnsplashImage = image"
            >
              <div
                class="h-48 w-full bg-cover border-primary"
