...
<template>
  <div>
    <page-header>
      <div slot="left-side">
        <div v-if="ready && entry">
          <span class="font-semibold" v-if="!status && form.published">Veröffentlicht</span>
          <span class="font-semibold" v-if="!status && !form.published">Entwurf</span>
    ...
    <div class="container">
      ...
      <h2 v-if="ready && !entry" class="text-center font-normal">404 — Post not found</h2>
    ...
    <modal v-if="settingsModalShown" @close="closeSettingsModal">
      <div class="input-group pt-0">
        ...
        <input type="text" class="input" v-model="form.slug" placeholder="Give me a slug" id="slug">
      ...
      <div class="input-group">
        ...
        <multiselect :options="tags" option-id="id" v-model="form.tags" option-text="name"></multiselect>
    ...
    <modal v-if="publishingModalShown" @close="publishingModalShown = false">
      ...
      >Make sure your post has a friendly title and slug.</div>
      ...
      <div class="mt-10">
        <button
          ...
          v-if="!form.published"
          v-loading="status"
        >Veröffentliche diesen Beitrag</button>
        <button
          class="btn-sm btn-primary"
          @click="publishPost"
          v-if="form.published"
          v-loading="status"
        >Aktualisiere Beitrag</button>
        <button
          class="btn-sm ml-1 btn-light"
          @click="unpublishPost"
          v-if="form.published"
          v-loading="status"
        >Ändere zu Entwurf</button>
